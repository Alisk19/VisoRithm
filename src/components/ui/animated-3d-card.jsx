...
const THEMES = {
  primary: "from-orange-600 via-orange-700 to-amber-800", // Adapted for Visualizer theme
  secondary: "from-stone-600 via-stone-700 to-stone-800", // Adapted for outline/secondary
  accent: "from-orange-500 via-[#c2652a] to-[#8b4513]",
  success: "from-emerald-600 via-emerald-700 to-emerald-800",
  warning: "from-amber-600 via-amber-700 to-amber-800",
  danger: "from-red-700 via-red-800 to-red-900", // Adapted for O(2^n)
  info: "from-cyan-600 via-cyan-700 to-cyan-800",
  neutral: "from-zinc-800 via-zinc-900 to-black", 
};
  ...
  (
    ...
    return (
      ...
      >
        ...
        <motion.div
          className="relative z-20 flex h-full flex-col p-6 text-white"
        ...
        >
          ...
          >
            <motion.h3
              className="font-headline text-3xl font-semibold tracking-tight drop-shadow-md"
              animate={{ scale: hovered ? 1.02 : 1 }}
              transition={{ duration: 0.3 }}
            ...
            <motion.p
              className="text-sm text-white/85 leading-relaxed drop-shadow-sm font-body"
